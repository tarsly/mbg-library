...
1. Searches memory for `realtor-toolkit preferences`
...
4. Saves to `brain/preferences/realtor-toolkit-preferences.md`
...
| Data Type | Path |
|---|---|
| Agent preferences | `brain/preferences/realtor-toolkit-preferences.md` |
